...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : Alarm_Indicator_Pin Pm_Indicator_Pin Buzzer_Pin */
  GPIO_InitStruct.Pin = Alarm_Indicator_Pin|Pm_Indicator_Pin|Buzzer_Pin;
  ...
  /*Configure GPIO pin : Set_Clock_Pin */
  GPIO_InitStruct.Pin = Set_Clock_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(Set_Clock_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : Set_Alarm_Pin Alarm_On_Pin */
  GPIO_InitStruct.Pin = Set_Alarm_Pin|Alarm_On_Pin;
  ...
  /*Configure GPIO pin : Snooze_Pin */
  GPIO_InitStruct.Pin = Snooze_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(Snooze_GPIO_Port, &GPIO_InitStruct);
